...
class EditBrother extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            nicknameInput: brother.nickname,
    ...
    render() {
        return (
            <form id='edit-brother' onSubmit={this.handleSubmit}>
                ...
                Nickame: <input type='text' value={this.state.nicknameInput}
                    onChange={this.handleNicknameChange} /><br />
